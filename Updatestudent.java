...
public class Updatestudent extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfaddress , tfphone , tfemail ,tfbranch ; // Student persoal details declare
    ...
    Updatestudent(){
        ...
        labelrollno.setFont(new Font("seril" , Font.PLAIN, 20));
        add(labelrollno);
        ...
        JLabel lblcourse = new JLabel ("Cource");
        lblcourse.setBounds(50 ,400,200,30);
        lblcourse.setFont(new Font("seril" , Font.BOLD, 20));
        add(lblcourse);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() ==submit) {
            ...
            String cource =tfcourse.getText();
            String branch =tfbranch.getText();
            
            try{
                  String query = "update student set address='" + address + "', phone='" + phone + "', email='" + email + "', course='" + cource + "', branch='" + branch + "' where rollno='" + rollno + "'";
