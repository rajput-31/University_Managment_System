...
public class Addteachers extends JFrame implements ActionListener{
    ...
    Addteachers(){
        ...
        lblempid.setFont(new Font("seril" , Font.BOLD, 20));
        add(lblempid);
        
        labelempid = new JLabel ("1014"+first4);
        labelempid.setBounds(200 ,200,200,30);
        labelempid.setFont(new Font("seril" , Font.BOLD, 20));
        add(labelempid);
        ...
        JLabel lblqul = new JLabel ("Qualification");
        lblqul.setBounds(50 ,400,200,30);
        lblqul.setFont(new Font("seril" , Font.BOLD, 20));
        add(lblqul);
       ...
       String cource[]={"BCA" ,"MCA" , "BBA" ,"MBA","B.tech" ,"M.tech","B.com","M.com","B.A" , "M.A"};//ceate array for cource dorpdown
        ...
        JLabel lblbranch = new JLabel ("Departments");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() ==submit) {
            ...
            try{
                String query = "insert into teacher values ('"+name+"' , '"+fname+"' ,'"+rollno+"' , '"+dob+"' , '"+address+"' ,'"+phone+"' , '"+email+"' , '"+x+"' , '"+xii+"' ,'"+aadhar+"' , '"+cource+"'  ,'"+branch+"' )";//DML command for database (update)
